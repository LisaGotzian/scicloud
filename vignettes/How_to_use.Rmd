...
+ an authorised connection to Elsevier (via your institution's network)
...
|Affiliation|Affiliation-City|Affiliation-Country|FileName|Abstrac|FullText|ID|     
...
![Porportion of Papers per Cluster](../Paper.png)
